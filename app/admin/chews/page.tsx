        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-3">
              {user.verificationStatus !== "VERIFIED" && (
                <button onClick={() => verifyMutation.mutate("VERIFIED")} disabled={verifyMutation.isPending}
                  className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2 text-xs font-semibold text-white bg-leaf rounded-xl hover:bg-leaf-dark disabled:opacity-60">
                  <CheckCircle className="w-3.5 h-3.5" /> Approve
                </button>
              )}
              {user.verificationStatus !== "REJECTED" && (
                <button onClick={() => verifyMutation.mutate("REJECTED")} disabled={verifyMutation.isPending}
                  className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2 text-xs font-semibold text-danger bg-danger-light rounded-xl hover:bg-danger/10 disabled:opacity-60">
          ...
          <div className="border-t border-border pt-5">
            <button
              ...
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 text-sm font-semibold text-danger bg-danger-light rounded-xl hover:bg-danger/10 disabled:opacity-60"
            >
